...
OPERATOR_LIBRARY = {
    ...
    # deben usar la MISMA libreria de operadores.
...
def fit_field(model: KANRecModel, field_idx: int, r2_threshold: float = 0.90) -> dict:
    ...
    NOTA: esto describe phi_j, la funcion de CODIFICACION del
...
for seed, ckpt in checkpoints:
    ...
    # ATENCION al interpretar esto: el percentil 20 descarta
...
print(
    "\nLa formula describe phi_j, la funcion de codificacion del campo "
    "(ajustada sobre las 16 dimensiones de su embedding), no la funcion "
    "de scoring completa: el scoring pasa ademas por las 26 categoricas, "
    "la capa de interaccion y la cabeza."
)
