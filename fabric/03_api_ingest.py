...
#
# Enriquece el conjunto de entrenamiento con metadatos de item obtenidos de
# una API REST. Requiere el servidor mock accesible (tunel ngrok activo).
# Attach kanrec_lakehouse before running.
#
# El paquete kanrec se resuelve desde el entorno del workspace. En ejecucion
# por pipeline los comandos magicos (%pip, %env) estan deshabilitados, de ahi
# que la URL de la API se resuelva por parametro, variable de entorno o
# fichero de configuracion, en ese orden.
