...
# URL del tunel ngrok: se lee de la variable de entorno ITEM_API_BASE
# (o del Key Vault en Fabric). Cambia en cada sesion de ngrok.
import os
API_BASE = os.environ.get("ITEM_API_BASE", "").rstrip("/")
if not API_BASE:
    raise RuntimeError(
        "ITEM_API_BASE no configurada. Ejecuta: "
        "%env ITEM_API_BASE=https://<subdominio>.ngrok-free.dev"
    )
